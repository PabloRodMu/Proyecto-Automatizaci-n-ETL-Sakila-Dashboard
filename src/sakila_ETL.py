...
def transformar_datos(df):
    ...
    df['fecha_devolucio'] = pd.to_datetime(df['fecha_devolucion'])
...
def ejecutar_etl():
    ...
    try:
        ...
        #Transformar
        df_transformados = transformar_datos(df)
        
        #Guardar CSV principal
        cargar_datos(df_transformados)
        
        #Retornar dataset para el dashboard
        return {
            'datos_principales': df_transformados
        }
